...
import 'package:metapos_owner/controller_model/controller/report_controller/customer_report_controller.dart';
...
class _CustomerReportState extends State<CustomerReport> {
  ...
  CustomerReportController customerReportController = Get.put(CustomerReportController());
  ...
  void getCustomerReport() async {
    if(customerReportController.isLoading) return;
    ...
    print("Fetch Customer Report  data => $body");
    customerReportController.getCustomerReport(body);
  }
...
@override
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body:GetBuilder<CustomerReportController>(
          builder: (controller){
                          ...
                          child: Column(
                            ...
                            children: [
                                  ...
                                  children: [
                                    ...
                                    Expanded(
                                      ...
                                      child: Align(
                                        ...
                                        child: _buildTopCategory("No.of order"),
                                      ),
                                    ),
                                  ],
                                ),
                              ...
                              ListView.builder(
                                ...
                                shrinkWrap: true,
                                itemCount: controller.topFiveOrderingCustomer.length,
                                itemBuilder: (context, index) {
                                  return Padding(
                                    padding: const EdgeInsets.symmetric(
                                      vertical: 6.0,
                                    ...
                                    child: Row(
                                      children: [
                                        Expanded(
                                          ...
                                          child: Center(
                                            child: TextWidget(
                                              title:controller.topFiveOrderingCustomer[index].name.toString(),
                                              fontSize: 12,
                                              textColor: ColorUtils.black,
                                              fontWeight: FontWeight.w600,
                                            ),
                                        ...
                                        Expanded(
                                          ...
                                          child: Align(
                                            alignment: Alignment.centerRight,
                                            child: TextWidget(
                                              title:controller.topFiveOrderingCustomer[index].totalOrders.toString(),
                                              fontSize: 12,
                                              textColor: ColorUtils.red,
                                              fontWeight: FontWeight.w600,
                                            ),
