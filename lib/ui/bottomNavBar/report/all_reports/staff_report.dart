...
import 'package:metapos_owner/controller_model/controller/report_controller/staff_sales_report_controller.dart';
...
class _StaffReportState extends State<StaffReport> {
  ...
  StaffSalesReportController staffSalesReportController = Get.put(
    StaffSalesReportController(),
  );
  ...
  void getStaffSalesReport() async {
    if (staffSalesReportController.isLoading) return;
    ...
    print("Fetch Staff Sales Report => $body");
    staffSalesReportController.getStaffSalesReport(body);
  }
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: GetBuilder<StaffSalesReportController>(
        builder: (controller) {
