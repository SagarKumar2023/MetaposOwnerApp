...
import 'package:metapos_owner/controller_model/controller/report_controller/staff_report_controller.dart';
...
class StaffHourReport extends StatefulWidget {
  const StaffHourReport({super.key});

  @override
  State<StaffHourReport> createState() => _StaffHourReportState();
}

class _StaffHourReportState extends State<StaffHourReport> {

  LoginController loginController = Get.find<LoginController>();
  StaffReportController staffReportController = Get.put(StaffReportController());
  ...
  void getStaffReport() async {
    if(staffReportController.isLoading) return;
    ...
    print("Fetch Staff Report data => $body");
    staffReportController.getStaffReport(body);
  }
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        title: TextWidget(
          title: "Staff Hour Report",
          textColor: ColorUtils.black,
          fontWeight: FontWeight.w700,
        ),
      ),
      body: GetBuilder<StaffReportController>(
          builder: (controller){
                                    ...
                                    child: Row(
                                      children: [
                                        ...
                                        Expanded(
                                          ...
                                          child: Center(
                                            child: TextWidget(
                                              title:controller.staffData[index].name.toString(),
                                              fontSize: 14,
                                              textColor: ColorUtils.black,
                                              fontWeight: FontWeight.w600,
                                            ),
                                        ...
                                        Expanded(
                                          ...
                                          child: Align(
                                            alignment: Alignment.centerRight,
                                            child: TextWidget(
                                              title:controller.staffData[index].totalHours.toString(),
                                              fontSize: 14,
                                              textColor: ColorUtils.red,
                                              fontWeight: FontWeight.w600,
                                            ),
                                        ...
                                        Expanded(
                                          ...
                                          child: Align(
                                            alignment: Alignment.centerRight,
                                            child: TextWidget(
                                              title:"\$${controller.staffData[index].hourlyRate.toString()}",
                                              fontSize: 14,
                                        ...
                                        Expanded(
                                          ...
                                          child: Align(
                                            alignment: Alignment.centerRight,
                                            child: TextWidget(
                                              title: "\$${ (controller.staffData[index].totalHours)! *
                                                  (double.parse(controller.staffData[index].hourlyRate.toString())) }",
                                              fontSize: 14,
                                              textColor: ColorUtils.green,
                                              fontWeight: FontWeight.w600,
                                            ),
